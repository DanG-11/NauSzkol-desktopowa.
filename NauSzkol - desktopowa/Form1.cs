...
namespace NauSzkol___desktopowa_
{
    public partial class NauSzkolMainForm : Form
    {
        ...
        private async Task LoadExercises()
        {
            try
            {
                if(cmbBoxStatus.Items.Count == 0)
                {
                    ...
                    cmbBoxPrzedmiot.Items.AddRange(new[] { "Matematyka", "Jêzyk polski", "Jêzyk angielski", "Historia", "Geografia", "Biologia", "Chemia", "Fizyka", "Informatyka", "WOS", "Religia", "Etyka", "Wychowanie fizyczne" });
                }
        ...
        private void btnEdytuj_Click(object sender, EventArgs e)
        {
            ...
            if (exercise == null)
            {
                MessageBox.Show("Nie uda³o siê pobraæ zadania");
                return;
            }

            var form = new FormularzDodawaniaZadan(_httpClient, exercise);
